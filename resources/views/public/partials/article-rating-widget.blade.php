...
<div class="rating-widget" id="ratingWidget" data-article-id="{{ $article->id }}">
...
async function submitRating(rating) {
    ...
    localStorage.setItem(`article_rating_${articleId}`, rating);
...
async function submitComment() {
    ...
    // Store in localStorage
    const articleId = document.getElementById('ratingWidget').dataset.articleId;
    localStorage.setItem(`article_rating_${articleId}`, 'commented');
