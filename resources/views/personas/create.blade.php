...
@section('content')
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="text-muted fs-14 mb-0">Build a detailed customer persona profile</p>
                </div>
    ...
    <form action="{{ route('personas.store') }}" method="POST" enctype="multipart/form-data" id="persona-form">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tagline" id="tagline" value="{{ old('tagline') }}" class="form-control" placeholder="e.g., The busy professional who values efficiency">
                                    @error('tagline')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="segmentation_tags" name="segmentation_tags" placeholder="Add segmentation tags..." value="{{ old('segmentation_tags', '') }}">
                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="age_range" id="age_range" value="{{ old('age_range') }}" class="form-control" placeholder="e.g., 30-35 or 32">
                                @error('age_range')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="occupation" id="occupation" value="{{ old('occupation') }}" class="form-control" placeholder="e.g., Marketing Manager">
                                @error('occupation')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="education" id="education" class="form-select" data-choices-disabled="true">
                                    ...
                                    <option value="Some College" {{ old('education') === 'Some College' ? 'selected' : '' }}>Some College</option>
                                    ...
                                    <option value="Professional Certification" {{ old('education') === 'Professional Certification' ? 'selected' : '' }}>Professional Certification</option>
                                </select>
                                @error('education')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="income" id="income" class="form-select" data-choices-disabled="true">
                                    ...
                                    <option value="$0 - $25,000" {{ old('income') === '$0 - $25,000' ? 'selected' : '' }}>$0 - $25,000</option>
                                    <option value="$25,000 - $50,000" {{ old('income') === '$25,000 - $50,000' ? 'selected' : '' }}>$25,000 - $50,000</option>
                                    <option value="$50,000 - $75,000" {{ old('income') === '$50,000 - $75,000' ? 'selected' : '' }}>$50,000 - $75,000</option>
                                    <option value="$75,000 - $100,000" {{ old('income') === '$75,000 - $100,000' ? 'selected' : '' }}>$75,000 - $100,000</option>
                                    <option value="$100,000 - $150,000" {{ old('income') === '$100,000 - $150,000' ? 'selected' : '' }}>$100,000 - $150,000</option>
                                    <option value="$150,000 - $200,000" {{ old('income') === '$150,000 - $200,000' ? 'selected' : '' }}>$150,000 - $200,000</option>
                                    <option value="$200,000+" {{ old('income') === '$200,000+' ? 'selected' : '' }}>$200,000+</option>
                                </select>
                                @error('income')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="motivations" name="motivations" placeholder="Add motivations..." value="{{ old('motivations', '') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="frustrations" name="frustrations" placeholder="Add frustrations..." value="{{ old('frustrations', '') }}">
                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="device_usage" name="device_usage" placeholder="Add devices..." value="{{ old('device_usage', '') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="channel_preference" name="channel_preference" placeholder="Add channels..." value="{{ old('channel_preference', '') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="workflow" id="workflow" rows="3" class="form-control" placeholder="Describe their typical workflow or daily routine...">{{ old('workflow') }}</textarea>
                                @error('workflow')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="buying_behavior" id="buying_behavior" rows="3" class="form-control" placeholder="Describe their purchasing patterns and decision-making process...">{{ old('buying_behavior') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="journey_stage" id="journey_stage" class="form-select" data-choices-disabled="true">
                                    ...
                                    <option value="Awareness" {{ old('journey_stage') === 'Awareness' ? 'selected' : '' }}>Awareness</option>
                                    <option value="Consideration" {{ old('journey_stage') === 'Consideration' ? 'selected' : '' }}>Consideration</option>
                                    <option value="Decision" {{ old('journey_stage') === 'Decision' ? 'selected' : '' }}>Decision</option>
                                    <option value="Retention" {{ old('journey_stage') === 'Retention' ? 'selected' : '' }}>Retention</option>
                                    <option value="Advocacy" {{ old('journey_stage') === 'Advocacy' ? 'selected' : '' }}>Advocacy</option>
                                </select>
                                @error('journey_stage')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="modules_interacted" name="modules_interacted" placeholder="Add modules..." value="{{ old('modules_interacted', '') }}">
                ...
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <div class="mb-3">
                            ...
                            <textarea name="bio" id="bio" rows="4" class="form-control" placeholder="Write a brief biography that captures who this persona is, their background, and what makes them unique...">{{ old('bio') }}</textarea>
                            @error('bio')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="quote" id="quote" rows="2" class="form-control" placeholder='"I need tools that just work without a steep learning curve..."'>{{ old('quote') }}</textarea>
                    ...
                    <div class="card-footer bg-white border-top">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-check me-1"></i> Create Persona
                            </button>
