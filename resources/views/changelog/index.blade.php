        ...
        <div class="card top-area">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">
                    <i class="ti ti-list me-2"></i>Changelog
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge badge-soft-success">{{ $changelogs->count() }} Change Logs</span>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="spacer">
                                        ...
                                        <span class="badge bg-success alt-primary-success">Published</span>
                                    ...
                                    <div class="spacer">
                                        <span class="span-tags">Author :</span> <span class="tag-value">{{ $changelog->author_name }} </span>
                                    </div>
                                    <div class="spacer">
                                        <span class="span-tags"> Category : </span>
